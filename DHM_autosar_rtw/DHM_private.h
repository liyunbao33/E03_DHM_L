...
extern void DHM_CtrlLogic(boolean rtu_SI_b_HallStall, SInt16 rtu_SI_s_CurrentPos,
  sint16 rtu_SI_s_MaxSoftPos, sint16 rtu_SI_s_MinSoftPos, sint16
  rtu_SI_s_IceBrkPos, boolean rtu_SI_b_DoorHndFoldReq, boolean
  rtu_SI_b_DoorHndUnfoldReq, Learn_Sts_E rtu_SI_m_LearnSts, uint8
...
extern void DHM_LearnLogic_Init(uint8 *rty_SO_e_MotorCmd, uint8
  *rty_SO_e_MotorPwm, boolean *rty_SO_b_CorrectPosToZero, boolean
  *rty_SO_b_CorrectPosToMax, Learn_Sts_E *rty_SO_m_LearnSts, sint16
  *rty_SO_s_MaxPos);
extern void DHM_LearnLogic(boolean rtu_SI_b_HallStall, Boolean rtu_SI_b_LearnReq,
  ...
  rtu_SI_s_CurrentPos, uint8 *rty_SO_e_MotorCmd, uint8 *rty_SO_e_MotorPwm,
  boolean *rty_SO_b_CorrectPosToZero, boolean *rty_SO_b_CorrectPosToMax,
  Learn_Sts_E *rty_SO_m_LearnSts, sint16 *rty_SO_s_MaxPos, DW_LearnLogic_DHM_T
  *localDW);
...
extern void DHM_FLDoorHndReq(Boolean rtu_SI_b_CrashOutpSts, UInt8
  rtu_SI_e_EspVehSpd, boolean rtu_SI_b_DoorOpen, Door_Sts_E rtu_SI_m_DoorLockSts,
  HndPos_Sts_E rtu_SI_m_HndPosSts, boolean *rty_SO_b_HndUnfoldReq, boolean
